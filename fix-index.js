...
if (!html.includes('function getFavs()')) {
  // Try to find a good place to inject. The <script> block for main.js starts somewhere.
  // We can just put it before renderHomeLatestCards
  html = html.replace('function renderHomeLatestCards', favFunctions + '\nfunction renderHomeLatestCards');
  fs.writeFileSync('Index.html', html, 'utf8');
  console.log('Fixed JS injection in Index.html!');
} else {
